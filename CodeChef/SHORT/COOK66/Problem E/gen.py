...
NOTE! To robustly test on arrays, generate arrays with all zeroes, all same numbers etc manually

genRandomString(size, lowchar, highchar)
NOTE! To robustly test on strings, manually generate strings made up of the same character
...
NOTE! To robustly test on graphs, manually generate star graphs, linear chain graph, complete graph etc
...
if __name__ == "__main__":
	...
	for t in xrange(T):
		for i in xrange(3):
			print genRandomString(randrange(1,N+1), 'a', 'z')
'''
